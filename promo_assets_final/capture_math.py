...
async def main():
    html_path = os.path.abspath('screenshots_ready/math_promo.html')
    output_png = 'screenshots_ready/math_promo_1280x800.png'
    output_jpg = 'screenshots_ready/math_promo_1280x800.jpg'
